...
class AetherUploadServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        $this->publishes([
            ...
            __DIR__ . '/../translations/zh/messages.php'    => base_path('resource/lang/vendor/aetherupload/zh/messages.php'),
            __DIR__ . '/../translations/en/messages.php'    => base_path('resource/lang/vendor/aetherupload/en/messages.php'),
