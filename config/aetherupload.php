...
return [
    ...
    "ENABLE_EXAMPLE_PAGE" => true,# 启用示例页面，访问/aetherupload/example或/aetherupload，生产环境下请将该选项设置为false
    ...
    "CHUNK_SIZE" => 1 * 1024 * 1024,# 上传时的分块大小（B），默认为1M，不能大于web服务器和php.ini中设置的上传限值
